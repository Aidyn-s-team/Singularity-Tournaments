...
const regPas = new RegExp('^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{8,30}$');
...
function onbluremail() {
    ...
    } else document.getElementById('erroremail').hidden = true;
}
function onblurlogin() {
    if (!regUsername.test(document.getElementById('username').value)) {
        error.classList.add('invalid');
        document.getElementById('error').hidden = false;
    } else document.getElementById('error').hidden = true;
}
function onblurname() {
    ...
    } else document.getElementById('errorname').hidden = true;
}
function onblursurname() {
    ...
    } else document.getElementById('errorsurname').hidden = true;
}
function onblurphone() {
    ...
    } else document.getElementById('errorphone').hidden = true;
}
function onblurpass() {
    const regPas1 = new RegExp('^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*~]{8,30}$');
    if (!regPas1.test(document.getElementById('password').value)) {
        errorpass.classList.add('invalid');
        document.getElementById('errorpass').hidden = false;
    } else document.getElementById('errorpass').hidden = true;
}
function onblurpass2() {
    const regPas2 = new RegExp('^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*~]{8,30}$');
    if (!regPas2.test(document.getElementById('password2').value || password !== password2)) {
        errorpass.classList.add('invalid');
        document.getElementById('errorpass2').hidden = false;
    } else document.getElementById('errorpass2').hidden = true;
}
...
//# sourceMappingURL=register.cea00a9b.js.map
